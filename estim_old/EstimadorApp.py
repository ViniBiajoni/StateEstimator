...
if __name__ == "__main__":
    ...
    y_bar_matriz, criticality_data, J_list, J_critical, State_dataframe, data_SE = state_estimation(line_params = 'Dados_linha_XIV_barras.xlsx', meansured_file = 'Teste14_sist_Internet.xlsx')
    print(data_SE)
